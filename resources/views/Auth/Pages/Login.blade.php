    ...
    <div class="auth-shell">
        ...
        <section class="auth-showcase d-none d-lg-flex" aria-hidden="true">
            <div class="auth-showcase-brand">
                ...
                <span class="brand-name">Chat Ai</span>
            </div>
            ...
            <div class="auth-panel-mobile-brand">
                <span class="brand-mark">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 2L14.5 9.5L22 12L14.5 14.5L12 22L9.5 14.5L2 12L9.5 9.5L12 2Z" fill="url(#brandGradMobile)" />
                        <defs>
            ...
            <div class="social-auth-group">
                <button type="button" class="btn-social" aria-label="Continue with Google">
                    <svg width="18" height="18" viewBox="0 0 24 24">
                        ...
                        <path fill="#34A853" d="M12 24c3.24 0 5.95-1.08 7.93-2.91l-3.88-3c-1.08.72-2.45 1.15-4.05 1.15-3.11 0-5.75-2.1-6.69-4.93H1.3v3.09A12 12 0 0 0 12 24z" />
                        ...
                        <path fill="#EA4335" d="M12 4.75c1.77 0 3.35.61 4.6 1.8l3.44-3.44C17.95 1.19 15.24 0 12 0A12 12 0 0 0 1.3 6.6l4.01 3.09C6.25 6.85 8.89 4.75 12 4.75z" />
                    </svg>
                    Google
                </button>
                <button type="button" class="btn-social" aria-label="Continue with GitHub">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="#111827">
                        <path d="M12 .3a12 12 0 0 0-3.79 23.39c.6.11.82-.26.82-.58v-2.02c-3.34.73-4.04-1.61-4.04-1.61-.55-1.39-1.34-1.76-1.34-1.76-1.09-.75.08-.73.08-.73 1.2.09 1.84 1.24 1.84 1.24 1.07 1.84 2.81 1.3 3.5.99.11-.78.42-1.3.76-1.6-2.67-.3-5.47-1.33-5.47-5.93 0-1.31.47-2.38 1.24-3.22-.12-.3-.54-1.53.12-3.18 0 0 1.01-.32 3.3 1.23a11.5 11.5 0 0 1 6 0c2.29-1.55 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.77.84 1.23 1.91 1.23 3.22 0 4.61-2.8 5.62-5.48 5.92.43.37.81 1.1.81 2.22v3.29c0 .32.22.7.83.58A12 12 0 0 0 12 .3z" />
                    </svg>
                    GitHub
                </button>
            </div>
            ...
            <form class="auth-form" id="loginForm" action="{{ route('login') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="input-affix">
                        ...
                        <input type="email" name="email" id="loginEmail" class="auth-input @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="you@company.com">
                    </div>
                    @error('email')
                ...
                <div class="form-group">
                    ...
                    <div class="input-affix">
                        ...
                        <input type="password" name="password" id="loginPassword" class="auth-input @error('password') is-invalid @enderror" placeholder="Enter your password">
                        <button type="button" class="password-toggle-btn" data-toggle-target="loginPassword" aria-label="Show password">
                ...
                <button type="submit" name="submit" class="btn-auth-submit" id="loginSubmitBtn">
                    <span>Log in</span>
