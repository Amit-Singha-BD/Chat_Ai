            ...
            <div class="auth-panel-mobile-brand">
                <span class="brand-mark">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 2L14.5 9.5L22 12L14.5 14.5L12 22L9.5 14.5L2 12L9.5 9.5L12 2Z" fill="url(#brandGradMobile2)" />
                        <defs>
                            <linearGradient id="brandGradMobile2" x1="2" y1="2" x2="22" y2="22" gradientUnits="userSpaceOnUse">
            ...
            <form class="auth-form" id="registerForm" novalidate>
                ...
                <div class="form-group">
                    ...
                    <div class="input-affix">
                        ...
                        <input type="password" name="password_confirmation" id="confirmPassword" class="auth-input" placeholder="Re-enter your password" autocomplete="new-password">
                        <button type="button" class="password-toggle-btn" data-toggle-target="confirmPassword" aria-label="Show password">
                            <i class="bi bi-eye" aria-hidden="true"></i>
                        </button>
                    </div>
                ...
                <button type="submit" name="submit" class="btn-auth-submit mt-3" id="registerSubmitBtn">
